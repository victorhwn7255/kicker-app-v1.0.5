...
- **Volume expectation (decision 2026-07-18):** 60-90 is a SLOT target; the novelty/length gates eat ~1/3+ of candidates by design, so **~40-60 published/day is the accepted healthy range** (pipeline_health flags below 40). Raising published volume = deeper vault re-exports (more fresh sources), NOT widening the band or the novelty ceiling.
