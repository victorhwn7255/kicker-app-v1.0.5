...
export function generatorSystem(): string {
  return [
    ...
    `5. LENGTH: between ${LENGTH.min} and ${LENGTH.max} characters. Aim for roughly 300-500;`,
    `   NEVER exceed ${LENGTH.max} - going over gets the post rejected outright. Do NOT pad,`,
    '   restate, or add filler to reach a length; a tight post is better than a padded one.',
    '   Lead with the single most important fact (given as KEY FACT). No hashtags, no emoji,',
    '   no @-handles.',
    '',
